...
export const lowestRatingFirst = arr => arr.sort((a, b) => parseInt(a.rating) - parseInt(b.rating))
export const highestRatingFirst = arr => arr.sort((a, b) => parseInt(b.rating) - parseInt(a.rating))